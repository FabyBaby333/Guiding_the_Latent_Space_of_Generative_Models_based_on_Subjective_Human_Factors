...
class LatentKDEClassifier:
    ...
    def _get_direction(self, log_likelihood_usable,  log_likelihood_unusable,gradient_usable, gradient_unusable, use_direction = 0, alpha = None):
        ...
        if use_direction == 3:
            ...
            if alpha is None:
                raise ValueError("The variable 'alpha' must not be None.")
            return (alpha)*gradient_usable - (1- alpha)*gradient_unusable
            # else:
